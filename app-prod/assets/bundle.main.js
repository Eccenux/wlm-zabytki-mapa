(() => {
    ...
    var __webpack_modules__ = {
        604(__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) {
                ...
                controller: function($timeout, $window, $mdDialog, mapService, versionService, dataService) {
                    ...
                    vm.map = mapService.getMap(), vm.showNatureDetails = function(data) {
                        ...
                        "monuments" === vm.version() ? url = function() {
                            ...
                            let url = uploadUrl;
                            return url += (location.pathname.startsWith("/_test") ? "wlm-pl-test" : "wlm-pl") + "&captionlang=pl", 
                            url += `&caption=${encodeURIComponent(description)}&categories=${encodeURIComponent(categories)}`, 
                            url += `&fields[0]=Q${vm.data.id}`, vm.data.voivodeship && (url += `&fields[1]=${encodeURIComponent(vm.data.voivodeship)}`), 
            ...
            __webpack_require__.dn(card_component);
            ...
            const navigationDialog_component = () => {
                angular.module("app").component("navigationDialog", NavigationDialogComponent);
            };
            __webpack_require__.dn(navigationDialog_component);
            ...
            __webpack_require__.dn(header_component);
            ...
            __webpack_require__.dn(main_component);
                                ...
                                const cards = function(results, bounds) {
                                    const llBounds = L.latLngBounds(bounds.southWest, bounds.northEast), cards = results.bindings.map(object => {
                                        ...
                                        return {
                                            ...
                                            voivodeship: object.adminCategory && object.adminCategory.value.includes(" Voivodeship") ? object.adminCategory.value : void 0
                                        };
            ...
            __webpack_require__.dn(map_component);
            ...
            __webpack_require__.dn(sidebar_component);
            const components = () => {
                main_component(), card_component(), header_component(), map_component(), sidebar_component(), 
                navigationDialog_component();
            };
            __webpack_require__.dn(components);
            var lib = __webpack_require__(247);
            ...
            }, downAccuracy = (d, digits = 5) => insertRight(Math.floor(d * Math.pow(10, digits)).toString(10), digits, "."), ceilAccuracy = (d, digits = 5) => insertRight(Math.ceil(d * Math.pow(10, digits)).toString(10), digits, "."), DataService = $http => {
                let lastCoord = {};
                const service = {
            ...
            __webpack_require__.dn(data_service);
            ...
            __webpack_require__.dn(map_service);
            ...
            __webpack_require__.dn(text_service);
            ...
            __webpack_require__.dn(version_service);
            const services = () => {
                data_service(), map_service(), text_service(), version_service();
            };
            __webpack_require__.dn(services), angular_default().module("app", [ "ngMaterial", "leaflet-directive" ]).config(function($mdThemingProvider, $provide) {
        ...
        911(module, __webpack_exports__, __webpack_require__) {
            ...
            ___CSS_LOADER_EXPORT___.push([ module.id, 'ww-header .ww-header__main{min-height:60px;background:#fff !important}ww-header .ww-header__main .md-toolbar-tools{height:60px;min-height:60px;padding:0;background:#000;color:#fff}ww-header .ww-header__logo{height:35px;margin-left:10px;margin-right:10px}@media(min-width: 890px){ww-header .ww-header__logo.img-short{display:none}}@media(max-width: 891px){ww-header .ww-header__logo.img-long{display:none}}@media(max-width: 700px){ww-header a.wikimedia{display:none}}ww-header .app-img-short{display:none}@media(max-width: 500px){.search-wasactive ww-header .app-img-long{display:none}.search-wasactive ww-header .app-img-short{display:inline-block}ww-header .logo-link{display:flex;justify-content:center}ww-header .logo-link img{height:auto;max-height:50px;width:90%;box-sizing:border-box;margin:0;padding:0}}ww-header .ww-header__title{color:#1d1d1d;font-size:17px;font-weight:bold;line-height:50px}ww-header .ww-header__buttons-toolbar{z-index:1;min-height:60px}ww-header .ww-header__search{height:100%;border:0;padding:10px 15px;background:#fff;color:gray;font-family:"Open Sans",sans-serif}ww-header .ww-header__search:focus{outline:0;background:#fff;color:#000}@media(max-width: 699px){ww-header .ww-header__search{font-size:18px}}ww-header .ww-header__search-clear{position:absolute;right:5px}ww-header .ww-header__search:focus+.ww-header__search-clear .material-icons{color:#000}ww-header .ww-header__search-results{position:fixed;z-index:10;top:60px;right:0;width:600px;background:#eee;color:#1d1d1d}@media(max-width: 699px){ww-header .ww-header__search-results{max-width:100%}}ww-header .ww-header__search-result{padding:5px 10px;font-size:18px;cursor:pointer}ww-header .ww-header__search-result:hover{background:#efefef}ww-header .ww-header__search-result small{opacity:.7}ww-header .ww-header__button{margin:0;padding:12px;border-radius:0;font-weight:600;font-size:18px}@media(max-width: 699px){ww-header .ww-header__button{font-size:14px}}ww-header .ww-header__button--monuments{background:#3498db}ww-header .ww-header__button--nature{background:#2ecc71}ww-header .ww-header__button--art{background:#9b59b6}', "" ]);
            const __WEBPACK_DEFAULT_EXPORT__ = ___CSS_LOADER_EXPORT___;
            __webpack_require__.d(__webpack_exports__, [ "A", 0, __WEBPACK_DEFAULT_EXPORT__ ]);
        },
        183(module, __webpack_exports__, __webpack_require__) {
            var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(645), _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__), _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(278), ___CSS_LOADER_EXPORT___ = __webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__)()(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default());
            ___CSS_LOADER_EXPORT___.push([ module.id, 'ww-main{display:flex;flex-direction:column;height:100%}ww-main .ww-container{flex:1}.ww-container{display:grid;grid-template-columns:minmax(370px, 1fr) 2fr}.ww-container ww-map .angular-leaflet-map{width:100%;height:100%}@media(max-width: 699px){.ww-container{grid-template-columns:1fr;grid-template-rows:1fr 16em;grid-template-areas:"map" "sidebar"}.ww-container ww-map{grid-area:map}.ww-container ww-sidebar{grid-area:sidebar}}.ww-map--loading{height:100%;display:flex;justify-content:center;align-items:center;padding:25px 10px;color:#757575;opacity:.5;text-align:center}.ww-map--loading .cssload-container{height:50px}', "" ]);
            const __WEBPACK_DEFAULT_EXPORT__ = ___CSS_LOADER_EXPORT___;
            __webpack_require__.d(__webpack_exports__, [ "A", 0, __WEBPACK_DEFAULT_EXPORT__ ]);
        },
        67(module, __webpack_exports__, __webpack_require__) {
            var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(645), _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__), _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(278), ___CSS_LOADER_EXPORT___ = __webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__)()(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default());
            ___CSS_LOADER_EXPORT___.push([ module.id, "ww-map{z-index:1}ww-map .ww-map-switcher{position:absolute;z-index:1000;right:0}ww-map .ww-map-switcher .md-button{width:70px;height:70px;font-size:12px;padding:0;min-width:70px;margin-left:0;margin-top:10px;margin-right:10px}ww-map .ww-map-switcher .md-button .material-icons{display:block;margin-top:10px}ww-map .leaflet-top,ww-map .leaflet-bottom{z-index:500}ww-map .leaflet-top .leaflet-control-zoom.leaflet-bar,ww-map .leaflet-bottom .leaflet-control-zoom.leaflet-bar{border-radius:0;border:4px solid #bbb}ww-map .leaflet-top.leaflet-right{display:none}ww-map .marker-cluster{--marker-color: #799}ww-map .marker-cluster.marker-cluster--art{--marker-color: rgba(155, 89, 182, 0.6)}ww-map .marker-cluster.marker-cluster--monuments{--marker-color: rgba(52, 152, 219, 0.6)}ww-map .marker-cluster.marker-cluster--monuments.marker-missing{--marker-color:rgba(219, 40, 40, 0.6)}ww-map .marker-cluster{background-color:var(--marker-color)}ww-map .marker-cluster>div{background-color:var(--marker-color)}", "" ]);
            const __WEBPACK_DEFAULT_EXPORT__ = ___CSS_LOADER_EXPORT___;
            __webpack_require__.d(__webpack_exports__, [ "A", 0, __WEBPACK_DEFAULT_EXPORT__ ]);
        },
        ...
        643(module, __webpack_exports__, __webpack_require__) {
            var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(645), _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__), _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(278), ___CSS_LOADER_EXPORT___ = __webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__)()(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default());
            ___CSS_LOADER_EXPORT___.push([ module.id, "ww-sidebar{position:relative;background:#fff;display:flex;flex-direction:column}ww-sidebar .ww-cards{flex:1}ww-sidebar .ww-sidebar-info{padding:25px 10px;color:#757575;opacity:.5;text-align:center}ww-sidebar .ww-sidebar-info .material-icons{font-size:50px;height:auto;width:auto;display:block}ww-sidebar .ww-cards{overflow:auto;width:100%;background:#ededed}ww-sidebar .ww-cards--loading{z-index:5;position:absolute;width:100%;background:#ededed}ww-sidebar .ww-sidebar-options{border-top:4px solid #ddd;width:100%;box-sizing:border-box;display:flex;gap:.5em}@media(max-width: 699px){ww-sidebar .ww-sidebar-options{gap:0}}ww-sidebar .ww-sidebar-options{flex-direction:column;font-weight:bold}ww-sidebar .ww-sidebar-options md-switch{margin-left:1em;margin-block:0;padding-block:.4em}@media(min-width: 24em){ww-sidebar .ww-sidebar-options md-switch{width:max-content;margin-inline:auto}}ww-sidebar .ww-sidebar-options md-switch{white-space:normal;display:flex;gap:.7em}ww-sidebar .ww-sidebar-options md-switch .md-container{width:35px;flex-shrink:0;padding:0;margin:0;box-sizing:border-box}@media(max-width: 699px){ww-sidebar .ww-sidebar-options md-switch,ww-sidebar .ww-sidebar-options button{font-size:85%}}ww-sidebar .ww-button-group{display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between}ww-sidebar .ww-button-group .md-button{min-width:0;text-align:left}", "" ]);
            const __WEBPACK_DEFAULT_EXPORT__ = ___CSS_LOADER_EXPORT___;
            __webpack_require__.d(__webpack_exports__, [ "A", 0, __WEBPACK_DEFAULT_EXPORT__ ]);
        },
        363(module, __webpack_exports__, __webpack_require__) {
            ...
            ___CSS_LOADER_EXPORT___.push([ module.id, '.cssload-container{width:100%;height:35px;text-align:center}.cssload-speeding-wheel{width:35px;height:35px;margin:0 auto;border:4px solid #757575;border-radius:50%;border-left-color:rgba(0,0,0,0);border-right-color:rgba(0,0,0,0);animation:cssload-spin 875ms infinite linear;-o-animation:cssload-spin 875ms infinite linear;-ms-animation:cssload-spin 875ms infinite linear;-webkit-animation:cssload-spin 875ms infinite linear;-moz-animation:cssload-spin 875ms infinite linear}@keyframes cssload-spin{100%{transform:rotate(360deg);transform:rotate(360deg)}}@-o-keyframes cssload-spin{100%{-o-transform:rotate(360deg);transform:rotate(360deg)}}@-ms-keyframes cssload-spin{100%{-ms-transform:rotate(360deg);transform:rotate(360deg)}}@-webkit-keyframes cssload-spin{100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@-moz-keyframes cssload-spin{100%{-moz-transform:rotate(360deg);transform:rotate(360deg)}}html,body{font-family:"Open Sans",sans-serif}', "" ]);
            const __WEBPACK_DEFAULT_EXPORT__ = ___CSS_LOADER_EXPORT___;
            __webpack_require__.d(__webpack_exports__, [ "A", 0, __WEBPACK_DEFAULT_EXPORT__ ]);
        },
    ...
    __webpack_require__.m = __webpack_modules__, (() => {
        ...
        __webpack_require__.O = (result, chunkIds, fn, priority) => {
            if (chunkIds) {
                ...
                return void (deferred[i] = [ chunkIds, fn, priority ]);
            }
            let notFulfilled = 1 / 0;
            for (i = 0; i < deferred.length; i++) {
                let [chunkIds, fn, priority] = deferred[i], fulfilled = !0;
                for (var j = 0; j < chunkIds.length; j++) (!1 & priority || notFulfilled >= priority) && Object.keys(__webpack_require__.O).every(key => __webpack_require__.O[key](chunkIds[j])) ? chunkIds.splice(j--, 1) : (fulfilled = !1, 
    ...
    __webpack_require__.dn = x => {
        ...
        (!descriptor || !descriptor.writable && descriptor.configurable) && Object.defineProperty(x, "name", {
            value: "default",
            configurable: !0
        });
    }, (() => {
        ...
        if (!scriptUrl && document && ("SCRIPT" === document.currentScript?.tagName.toUpperCase() && (scriptUrl = document.currentScript.src), 
        !scriptUrl)) {
            const scripts = document.getElementsByTagName("script");
            if (scripts.length) {
                let i = scripts.length - 1;
                for (;i > -1 && (!scriptUrl || !/^http(s?):/.test(scriptUrl)); ) scriptUrl = scripts[i--].src;
            }
        }
    ...
    let __webpack_exports__ = __webpack_require__.O(void 0, [ 488 ], () => __webpack_require__(604));
